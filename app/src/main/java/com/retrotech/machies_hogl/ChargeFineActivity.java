...
public class ChargeFineActivity extends AppCompatActivity {
    Toolbar toolbar;
    EditText amount;
    TextView select_member,post_member_saving,select_ID,fine_reason,contribution_date;
    String submit_saving_url=BASE_URL+"charge_fine.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contribution_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(ChargeFineActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        context = ChargeFineActivity.this;
    ...
    private void startSubmission(
            final String amount,String select_member,String id,String contribution_date,String group_id,String default_disbursed,String reason ){
