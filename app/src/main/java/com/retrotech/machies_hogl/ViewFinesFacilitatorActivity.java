...
import com.retrotech.machies_hogl.adapters.ViewFinesFacilitatorAdapter;
...
public class ViewFinesFacilitatorActivity extends AppCompatActivity {
    RecyclerView members_recyclerview;
    RequestQueue mRequestQueue;
    ArrayList<ViewFinesFacilitatorModel> listFines = new ArrayList<ViewFinesFacilitatorModel>();
    Context context;
    String str_a, members_list = BASE_URL + "view_group_total_fines_facilitator.php";
    String str_user_role,str_my_name,str_group_name;
    ViewFinesFacilitatorAdapter viewFinesFacilitatorAdapter;
    Toolbar toolbar;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_fines_facilitator);
...
//                        JSONObject stackObject2 = array2.getJSONObject(i);
                        ...
                        ViewFinesFacilitatorModel modelFines = new  ViewFinesFacilitatorModel(
                                stackObject.getString("total_fine_charged"),
                                stackObject.getString("total_fine_paid"),
                                stackObject.getString("fines_balance"),
                                stackObject.getString("group_name"),
                                stackObject.getString("group_id")


                        );
                        listFines.add(modelFines);
                    }
...
//                        no_transactions_txt.setVisibility(View.VISIBLE);
                        ...
                        viewFinesFacilitatorAdapter = new ViewFinesFacilitatorAdapter(listFines,getBaseContext());
                        members_recyclerview.setAdapter(viewFinesFacilitatorAdapter);
