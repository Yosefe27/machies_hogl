...
public class TransactionHistoryAdapter extends RecyclerView.Adapter<TransactionHistoryAdapter.ViewHolder> implements Filterable {
    ...
    //constructor
    public TransactionHistoryAdapter(Context context, ArrayList<PaymentOptions> listPaymentOptions){
