...
import com.retrotech.machies_hogl.adapters.ViewSocialFundAdapter;
...
public class OrdinaryViewSocialFundsForMembersActivity extends AppCompatActivity {

    RecyclerView members_recyclerview;
    RequestQueue mRequestQueue;
    ArrayList<ViewSocialFundModel> listMembers = new ArrayList<>();
    Context context;
    String str_a, members_list = BASE_URL + "view_social_funds.php";
    ViewSocialFundAdapter viewSocialFundAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ordinary_view_social_funds_for_members);
...
//                    String str_register = object.getString("register");
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        ViewSocialFundModel members = new ViewSocialFundModel(
...
//                        no_transactions_txt.setVisibility(View.VISIBLE);
                        ...
                        viewSocialFundAdapter = new ViewSocialFundAdapter(getBaseContext(), listMembers);
                        members_recyclerview.setAdapter(viewSocialFundAdapter);
                        viewSocialFundAdapter.setClickListener(new View.OnClickListener() {
                            @Override
...
//        And to prevent dialog box from getting dismissed on outside touch use this
    ...
    public void onBackPressed() {
        Intent intent = new Intent(getApplicationContext(), OrdinaryMemberSocialFundDashboard.class);
