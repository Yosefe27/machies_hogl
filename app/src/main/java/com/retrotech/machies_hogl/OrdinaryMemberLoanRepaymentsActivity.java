...
public class OrdinaryMemberLoanRepaymentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ordinary_member_loan_repayments);
        loan_requests_recylerview = findViewById(R.id.loan_requests_recylerview);
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle("My Loan Repayment");
        toolbar.setSubtitle("My Loan Repayment");
...
//        loan_approvals.setVisibility(View.GONE);
        ...
        context = OrdinaryMemberLoanRepaymentsActivity.this;
