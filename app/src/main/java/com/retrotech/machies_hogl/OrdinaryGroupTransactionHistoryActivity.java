...
public class OrdinaryGroupTransactionHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ordinary_group_transaction_history);
        transactions_recylerview = findViewById(R.id.transactions_recyclerview);

        context = OrdinaryGroupTransactionHistoryActivity.this;
...
//        And to prevent dialog box from getting dismissed on outside touch use this
    ...
    public void onBackPressed() {
        finish();
        Intent intent = new Intent(getApplicationContext(), OrdinaryMemberSavingsDashboard.class);
