...
public class FacilitatorGroupFines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facilitator_fines);
        ...
        context = FacilitatorGroupFines.this;
...
//                        no_transactions_txt.setVisibility(View.VISIBLE);
                        ...
                        groupsAdapter.setClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), FacilitatorMembersFines.class);
