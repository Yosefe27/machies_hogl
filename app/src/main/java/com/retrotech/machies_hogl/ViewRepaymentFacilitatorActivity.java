...
import static com.retrotech.machies_hogl.R.id.toolbar;
...
import com.retrotech.machies_hogl.adapters.ViewLoanRepaymentAdapter;
...
public class ViewRepaymentFacilitatorActivity extends AppCompatActivity {
    ...
    Context context;
    String str_a, members_list = BASE_URL + "view_group_total_repayments_facilitator.php";
    String str_user_role,str_my_name,str_group_name;
    ViewLoanRepaymentAdapter viewGroupSavingFacilitatorAdapter;
    Toolbar toolbar;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_repayment_facilitator);
        ...
        context = ViewRepaymentFacilitatorActivity.this;
...
//                        JSONObject stackObject2 = array2.getJSONObject(i);
                        ...
                        ViewGroupSavingFacilitatorModel savings = new  ViewGroupSavingFacilitatorModel(
                                ...
                                stackObject.getString("total_repayments")
...
//                        no_transactions_txt.setVisibility(View.VISIBLE);
                        ...
                        viewGroupSavingFacilitatorAdapter = new ViewLoanRepaymentAdapter(listMembers,getBaseContext());
