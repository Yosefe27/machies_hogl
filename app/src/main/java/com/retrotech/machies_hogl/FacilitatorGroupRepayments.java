...
public class FacilitatorGroupRepayments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facilitator_repayments);
        ...
        context = FacilitatorGroupRepayments.this;
...
//                        no_transactions_txt.setVisibility(View.VISIBLE);
                        ...
                        groupsAdapter.setClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), FacilitatorMembersRepayments.class);
