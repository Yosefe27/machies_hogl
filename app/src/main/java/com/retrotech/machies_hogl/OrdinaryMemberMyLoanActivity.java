...
public class OrdinaryMemberMyLoanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ordinary_member_my_loan);
...
//        loan_approvals.setVisibility(View.GONE);
        ...
        context = OrdinaryMemberMyLoanActivity.this;
