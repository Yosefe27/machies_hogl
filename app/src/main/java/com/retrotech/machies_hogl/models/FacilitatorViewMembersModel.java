...
public class FacilitatorViewMembersModel {
    private String id;
    ...
    public FacilitatorViewMembersModel(String id, String group_name, String date_created, String annual_interest_rate, String cycle_number, String first_training_meeting_date, String date_savings_started, String reinvested_savings_cycle_start, String registered_members_cycle_start, String status) {
        this.id = id;
