...
import com.retrotech.machies_hogl.adapters.ViewSocialFundFacilitatorAdapter;
...
public class ViewSocialFundFacilitatorActivity extends AppCompatActivity {

    RecyclerView members_recyclerview;
    RequestQueue mRequestQueue;
    ArrayList<ViewSocialFundFacilitatorModel> listSocial = new ArrayList<ViewSocialFundFacilitatorModel>();
    Context context;
    String str_a, members_list = BASE_URL + "view_group_total_social_fund_facilitator.php";
    String str_user_role,str_my_name,str_group_name;
    ViewSocialFundFacilitatorAdapter viewSocialFundFacilitatorAdapter;
    Toolbar toolbar;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_social_fund_facilitator);

        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle("Group Repayment");
        toolbar.setSubtitle("Group Repayment");
...
//                        JSONObject stackObject2 = array2.getJSONObject(i);
                        ...
                        ViewSocialFundFacilitatorModel modelSocial = new  ViewSocialFundFacilitatorModel(
                                stackObject.getString("total_social_in"),
                                stackObject.getString("total_social_out"),
                                stackObject.getString("social_fund_balance"),
                                stackObject.getString("group_name"),
                                stackObject.getString("group_id")


                        );
                        listSocial.add(modelSocial);
                    }
...
//                        no_transactions_txt.setVisibility(View.VISIBLE);
                        ...
                        viewSocialFundFacilitatorAdapter = new ViewSocialFundFacilitatorAdapter(listSocial,getBaseContext());
                        members_recyclerview.setAdapter(viewSocialFundFacilitatorAdapter);
//                        viewFinesFacilitatorAdapter.setClickListener(new View.OnClickListener() {
//                            @Override
