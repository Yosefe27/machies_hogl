...
import com.retrotech.machies_hogl.adapters.MemberProfileAdapter;
...
public class MemberProfileActivity extends AppCompatActivity {
    ...
    Context context;
    String str_a, members_list = BASE_URL + "view_member_balances.php";
...
//                    String str_register = object.getString("register");
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        MemberProfileModel members = new  MemberProfileModel (
                    ...
                    if (listMembers.size() <= 0) {
                        ...
                        memberProfileAdapter = new MemberProfileAdapter(listMembers,getBaseContext());
