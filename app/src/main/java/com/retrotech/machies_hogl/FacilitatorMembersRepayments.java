...
public class FacilitatorMembersRepayments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setSubtitle("Group Members Repayments");
        ...
        context = FacilitatorMembersRepayments.this;
